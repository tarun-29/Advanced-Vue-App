      ...
      <div class="team-card-front" :style="style(team.photo)">
        <div class="content" :style="{ background: team.color }">
          ...
          <div class="best-result">
            <img
              src="@/assets/static/img/misc/cup.png"
              alt=""
              style="height: 148px; z-index: 2; position: absolute"
            />
          ...
          <div class="performance">
            <div class="bar">
              ...
              <div class="tie" :style="{ color: team.color.slice(25, 34) }">
                <span
                  ...
                  }}<sup style="font-size: 19px">*</sup></span
                >
            ...
            <div class="info">
              <span
                style="
                   {
                    'background':team.color.slice(25, 34) ;
                  }
                "
                >*</span
              >T+W and T+L indicates matches tied and then won or lost by "Super
              Over"
            </div>
          </div>
        </div>
