    ...
    <div class="card">
      <div class="team-card-front" :style="style(team.photo)" >
        <div class="content" :style="{'background': team.color}">
          <div class="logo">
            <img :src="require(`@/assets/${team.image}`)" :alt="team.name" :width="team.width" :style="{'marginTop': team.marginTop}">
          </div>
          <div class="text">
            <div class="team-name">
              {{team.name}}
          ...
          <div class="best-result">
            <img src="@/assets/static/img/misc/cup.png" alt="" style="height: 148px;z-index: 2;position: absolute">
